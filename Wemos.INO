...
const char* ssid     = "ssid goes here";      // SSID of local network
const char* password = "password goes here";   // Password on network
String APIKEY = "API Key goes here"; // see https://openweathermap.org/appid
//String CityID = "6942529"; //Durbanville / ZA
String CityID = "3369157"; //Cape Town / ZA Go to https://openweathermap.org/city/ and insert city name - if found number is now in URL 


WiFiClient client;
char servername[]="api.openweathermap.org";  // remote server we will connect to
char server[]="www.hamqsl.com";// remote server we will connect to get ham date
String result;
